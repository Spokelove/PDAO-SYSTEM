...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('typesdisability', function (Blueprint $table) {
            $table->id(); // Auto-incremental primary key
            $table->unsignedBigInteger('pwdmember_id'); // Foreign key referencing the pwdmember table
            $table->string('types_of_disability'); // Column for types of disability
    ...
    {
        Schema::dropIfExists('typesdisability');
    }
};
