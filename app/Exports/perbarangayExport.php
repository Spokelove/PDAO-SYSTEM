    ...
    public function headings(): array
    {
        ...
        public function query()
        {
            return PwdMember::select(
                ...
                'pwd_member.birthday',
                'pwd_member.gender',
                \DB::raw('YEAR(CURDATE()) - YEAR(pwd_member.birthday) as age'),
                'pwd_member.status',
                'residence.purok',
                'residence.barangay',
