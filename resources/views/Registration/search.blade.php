          ...
          <table class="min-w-full text-left text-sm font-light text-black bg-gray">
            ...
            @foreach ($Pwdmembers as $Pwdmember)
              <tr
                ...
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->date_applied}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->application}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->last_name}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->first_name}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->middle_name}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->suffix_of_applicant}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->birthday}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->age}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->purok}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->house_and_street}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->barangay}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->municipality}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->status}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->occupations}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->disabilitypes}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->cause_of_disability}}</td>
                <td class="whitespace-nowrap px-6 py-4">{{ $Pwdmember->Devices_given}}</td>
