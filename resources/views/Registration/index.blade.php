...
<h1 class= " font-bold ml-4 w-full text-black text-white-500 text-black-500 bg-white-100 p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">PWD Transactions</h1>
        ...
        <nav class = " flex px-5 py-3 text-gray-700  rounded-lg bg-stone-100 dark:bg-[#1E293B] " aria-label="Breadcrumb">
            <ol class = "inline-flex items-center space-x-1 md:space-x-3">
                <li class = "inline-flex items-center">             
                   ...
                   <button class="carousel-button" onclick="showSlide(8)"> Medical Assistance</button>
                   <button class="carousel-button" onclick="showSlide(9)"> Livelihood Assistance</button>
                   <button class="carousel-button" onclick="showSlide(10)"> Issues With ID's</button>
 ...
 <form action ="{{ route('registration.store') }}" method="POST" enctype="multipart/form-data class=" >
  ...
  <!-- start0     Member  Information              -->
  <div class="carousel">
    <div class="carousel-content">
        <div class="slide relative border border-gray-200 rounded-lg bg- bg-white mt-5 "id="slide0">
            <h6 class="text-blueGray-400 text-xl mt-3 mb-10 font-bold uppercase ml-5">Member Information</h6>
            <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>
            <div class="flex flex-wrap mt-5">
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <input autocomplete="off" name="pwd_no" id="pwd_no" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="pwd_no" value="{{$result->pwd_no}}">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <input autocomplete="off" name="date_applied" id="date_applied" type="date" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="date_applied" value={{old('date_applied')}}>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        ...
                        <select name="application" id="application" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                            <option value="new" {{ request('application') === 'new' ? 'selected' : '' }}>New</option>
                            <option value="renew" {{ request('application') === 'renew' ? 'selected' : '' }}>Renew</option>
                            <option value="transfer" {{ request('application') === 'renew' ? 'selected' : '' }}>Transfer</option>
                        </select>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <input autocomplete="off" id="last_name" name="last_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="last_name." value={{old('last_name')}}>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <input autocomplete="off" id="first_name" name="first_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="first_name" />
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <input autocomplete="off" id="middle_name" name="middle_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="middle_name" value={{old('middle_name')}}>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password"> </label>
                        <select name="suffix_of_father" id="suffix_of_father" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                            ...
                            <option value="VI" {{old('suffix_of_father') == "VI" ? 'selected' : ''}}>VI</option>
                            <option value="VII" {{old('suffix_of_father') == "VII" ? 'selected' : ''}}>VII</option>
                            <option value="VIII" {{old('suffix_of_father') == "VIII" ? 'selected' : ''}}>VIII</option>
                        </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                        </div>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <input autocomplete="off" id="birthday" name="birthday" type="date" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" value={{old('birthday')}}>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-50 mt-7">
                        <input type="integer" id="age" name="age" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Age">
                    </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password"></label>
                        <select name="gender" id="gender" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password"></label>
                        <select name="status" id="status" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
...
<!-- start 1 RESIDENCE AND EMPLOYMENT INFORMATION-->
<div class="carousel">
    <div class="carousel-content">
        <div class="slide relative border border-gray-200 rounded-lg bg-white mt-5 "id="slide1">
            ...
            <div class="flex flex-wrap mt-5">
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <input autocomplete="off" name="house_and_street" id="house_and_street" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="House No. and Street" />
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        ...
                        <select name="purok" id="purok" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="grid-password"></label>
                        <select name="barangay" id="barangay" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="grid-password"></label>
                        <select name="municipality" id="municipality" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <input autocomplete="off" name="landline" id="landline" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="Landline_No" />
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="grid-password"></label>
                        <select name="educational_attain" id="educational_attain" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
            ...
            <div class="flex flex-wrap mt-5 w-full">
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="grid-password"></label>
                        <select name="status_of_employment" id="status_of_employment" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="grid-password"></label>
                        <select name="category_of_employment" id="category_of_employment" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="grid-password"></label>
                        <select name="types_of_employment" id="types_of_employment" class="focus:ring-1 focus:ring-blue-600 block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
...
<!-- end 2-->
  <!-- start2Family Background  And ID References -->
  <div class="carousel">
            <div class="carousel-content">
                      <div class="slide relative border border-gray-200 rounded-lg bg-white mt-5 "id="slide2">
                            ...
                            <h6 class="text-blueGray-400 text-xl mt-3 mb-6 font-bold uppercase ml-5 ">Family Background  And ID References </h6>                                      
                             ...
                             <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-7">
                                            <input autocomplete="off"  name="father_first_name"  id="father_first_name"type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="father_first_name" />
                                      ...
                                      <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-7">
                                            <input autocomplete="off"  name="father_middle_name" id="father_middle_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="father_middle_name" />
                                     ...
                                     <div class="w-full lg:w-3/12 px-4">
                                         <div class="relative w-full mb-3 mt-7">
                                          <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password"></label>
                                              ...
                                              <option value=""   {{old('suffix_of_reporting_unit') == "" ?    'selected' :  ''}}>Select Suffix</option>
                               ...
                               <div class="w-full lg:w-4/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                              <input autocomplete="off"  name="mother_last_name" id="mother_last_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="mother_last_name" />
                              ...
                              <div class="w-full lg:w-4/12 px-4">
                                     <div class="relative w-full mb-3 mt-5">
                                             <input autocomplete="off" name="mother_first_name" id="mother_first_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="mother_first_name" />
                              ...
                              <div class="w-full lg:w-4/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="mother_middle_name"  id="mother_middle_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="mother_middle_name" />
                                 ...
                                 <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="guardian_last_name"  id="guardian_last_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="guardian_last_name" />
                                 ...
                                 <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="guardian_first_name" id="guardian_first_name"  type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="guardian_first_name" />
                                 ...
                                 <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="guardian_middle_name" id="guardian_middle_name"  type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="guardian_first_name" />
                                           <label for="guardian_first_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Guard middle name</label>
                                    </div>
                                 </div>
                         ...
                         <div class="relative w-full mb-3   mt-5">
                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password"> </label>                                        
                            <select  name="suffix_of_reporting_unit"   id="suffix_of_reporting_unit" class="  focus:ring-1 focus:ring-blue-600  block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                <option value="" {{old('suffix_of_reporting_unit') == "" ?        'selected' : ''}}> Select Suffix</option>
                                <option value="Jr." {{old('suffix_of_reporting_unit') == "Jr." ? 'selected' : ''}}>Jr.</option>
                                <option value="Sr."  {{old('suffix_of_reporting_unit') == "Sr." ? 'selected' : ''}}>Sr.</option>
                                <option value="I"   {{old('suffix_of_reporting_unit') == "I" ?   'selected' : ''}}>I</option>
                   ...
                   <div class="w-full lg:w-4/12 px-4">
                       <div class="relative w-full mb-3 mt-7">
                            <input autocomplete="off" name="sss_no"   id="sss_no" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="sss_no" />
                       ...
                       <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                            <input autocomplete="off" name="gsis_no"   id="gsis_no" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="gsis_no" />
                       ...
                       <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                            <input autocomplete="off" name="pag-ibig_no"   id="pag-ibig_no" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="pag-ibig_no" />
                       ...
                       <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                            <input autocomplete="off" name="psn_no"   id="psn_no" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="psn_no" />
                       ...
                       <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3 mt-7">
                            <input autocomplete="off" name="philhealth"   id="philhealth" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="philhealth" />
...
<!-- end2 -->
<!--    
  start3Types of Disability  -->
  <div class="carousel">
        <div class="carousel-content p-5">
            <div class="slide relative border border-gray-200 rounded-lg bg-white mt-5 "id="slide3">
                          
           <h6 class="text-blueGray-400 text-xl  mb-6 font-bold uppercase ml-5 ">Types of Disability  </h6>                                                                                    
           <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>       
        
         <div class="grid grid-cols-5 gap-4  mt-5">
                  <div class="bg-slate-100 p-4">
                        <label class="flex items-center space-x-2 ">
                       <input type="checkbox"  id="checkbox1" name="disabilitypes[]" value="Deaf or Hard Of Hearing" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
    ...
    <div class="grid grid-cols-5 gap-4">
                   ...
                   <div class="bg-slate-100 p-4">
                       <label class="flex items-center space-x-2">
                       <input type="checkbox" id="checkbox17" name="cause_of_disability[]" value="Celebral Palsy" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                       <span>Celebral Palsy</span>
                      </label>
                    </div>
...
<!-- start4 ORGANIZATION AND ACCOMPLISHED BY-->
<div class="carousel">
            <div class="carousel-content">
                             ...
                             <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full lg:w-3/12 px-4">
                                     ...
                                     <div class="relative w-full mb-3 mt-5">
                                             ...
                                             <label for="applicant_last_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Applicant Last name</label>
                                        </div>
                                       </div>
                              ...
                              <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           ...
                                           <label for="applicant_first_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Applicant First Name</label>
                                    </div>
                                 </div>
                                 ...
                                 <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           ...
                                           <label for="applicant_middle_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Applicant Middle Name</label>
                                    </div>
                                 </div>
               ...
               <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-7">
                                           <input autocomplete="off" name="guard_last_name"   id="guard_last_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="guard_last_name" />
               ...
               <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="guard_first_name" id="guard_first_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="guard_first_name" />
                                           <label for="guard_first_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Guard first name</label>
                                    </div>
                                 </div>
            ...
            <div class="carousel-content">
                      <div class="slide relative border border-gray-200 rounded-lg bg-white mt-5 "id="slide5">
                            ...
                            <h6 class="text-blueGray-400 text-xl mt-3 mb-6 font-bold uppercase ml-5 "> APPROVING OFFICERS </h6>                                      
                             ...
                             <div class="w-full lg:w-3/12 px-4">
                                  <div class="relative w-full mb-3 mt-7">
                                        <input autocomplete="off"  name="licensed_no_of_physician" id="licensed_no_of_physician" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="licensed_no_of_physician" />
                                         <label for="licensed_no_of_physician" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Licensed No.</label>
                                    </div>
                               </div>

                                    <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-7">
                                            <input autocomplete="off"  name="last_name_of_physician" id="last_name_of_physician" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="last_name_of_physician" />
                                            <label for="last_name_of_physician" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Last name *</label>
                                        </div>
                                      </div>
                                      ...
                                      <div class="relative w-full mb-3 mt-7">
                                            <input autocomplete="off"  name="first_name_of_physician" id="first_name_of_physician" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="first_name_of_physician" />
                                            <label for="first_name_of_physician" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">First name *</label>
                                        </div>
                                      </div>

                                      <div class="w-full lg:w-2/12 px-4">
                                      <div class="relative w-full mb-3 mt-7">
                                            <input autocomplete="off"  name="middle_name_of_physician"  id="middle_name_of_physician" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="middle_name_of_physician" />
                                            <label for="middle_name_of_physician" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Middle name *</label>
                                        </div>
                                      </div>
                                    ...
                                    <div class="relative w-full mb-5">
                                           ...
                                           <select  name -="suffix_of_physician"  id="suffix_of_physician" class="  focus:ring-1 focus:ring-blue-600  block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                           <option value=""    {{old('suffix_of_physician') == "" ?    'selected' : ''}}>  Suffix </option>
                                           <option value="Jr." {{old('suffix_of_physician') == "Jr." ? 'selected' : ''}}>Jr.</option>
                                           <option value="Sr." {{old('suffix_of_physician') == "Sr." ? 'selected' : ''}}>Sr.</option>
                                           <option value="I"   {{old('suffix_of_physician') == "I" ?   'selected' : ''}}>I</option>
                                           <option value="II"  {{old('suffix_of_physician') == "II" ?  'selected' : ''}}>II</option>
                                           <option value="III" {{old('suffix_of_physician') == "III" ? 'selected' : ''}}>III</option>
                                           <option value="IV"  {{old('suffix_of_physician') == "IV" ?  'selected' : ''}}>IV</option>
                                           <option value="V"   {{old('suffix_of_physician') ==  "V" ?  'selected' : ''}}>V</option>         
                                         </select>
                                           <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                                       </div>    
                                ...
                                <div class="w-full lg:w-12/12 px-4  font- uppercase text-sm">PROCESSING OFFICER  </div> 
                                      <div class="w-full lg:w-3/12 px-4">
                                     <div class="relative w-full mb-3 mt-5">
                                             <input autocomplete="off" name="last_name_of_processing_officer" id="last_name_of_processing_officer" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="last_name_of_processing_officer" />
                                             <label for="last_name_of_processing_officer" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs"> Last name *</label>
                                        </div>
                                       </div>
                    
                              <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="first_name_of_processing_officer" id="first_name_of_processing_officer" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="first_name_of_processing_officer" />
                                           <label for="first_name_of_processing_officer" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs"> First Name *</label>
                                    </div>
                                 </div>
                                 ...
                                 <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="middle_name_of_processing_officer"  id="middle_name_of_processing_officer" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="middle_name_of_processing_officer" />
                                           <label for="middle_name_of_processing_officer" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs"> Middle Name *</label>
                                    </div>
                                 </div>
                   ...
                   <div class="w-full lg:w-3/12 px-4">
                      <div class="relative w-full mb-3 mt-5">
                <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password"> </label>                                        
                <select  name="suffix_of_processing_officer"   id="suffix_of_processing_officer"  class="  focus:ring-1 focus:ring-blue-600  block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                   <option value=""     {{old('suffix_of_processing_officer') == "" ?    'selected' : ''}}> Suffix </option>
                   <option value="Jr."  {{old('suffix_of_processing_officer') == "Jr." ? 'selected' : ''}}>Jr.</option>
                   <option value="Sr."  {{old('suffix_of_processing_officer') == "Sr." ? 'selected' : ''}}>Sr.</option>
                   <option value="I"    {{old('suffix_of_processing_officer') == "I" ?   'selected' : ''}}>I</option>
                   <option value="II"   {{old('suffix_of_processing_officer') == "II" ?  'selected' : ''}}>II</option>
                    <option value="III" {{old('suffix_of_processing_officer') == "III" ? 'selected' : ''}}>III</option>
                    <option value="IV"  {{old('suffix_of_processing_officer') == "IV" ?  'selected' : ''}}>IV</option>
                    <option value="V"   {{old('suffix_of_processing_officer') ==  "V" ?  'selected' : ''}}>V</option>           
                   </select>
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                       <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                    </div>    
              ...
              <div class="w-full lg:w-12/12 px-4  font- uppercase text-sm">APPROVING OFFICER  </div> 
               <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="last_name_of_approving_officer"   id="last_name_of_approving_officer" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="last_name_of_approving_officer" />
                                           <label for="last_name_of_approving_officer" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs"> Last Name *</label>
                                   </div>
                              </div>
               ...
               <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="first_name_of_approving_officer" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="first_name_of_approving_officer" />
                                           <label for="first_name_of_approving_officer" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs"> first name *</label>
                                    </div>
                                 </div>
               ...
               <div class="w-full lg:w-3/12 px-4">
                                      <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off" name="middle_name_of_approving_officer" id="middle_name_of_approving_officer" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="middle_name_of_approving_officer" />
                                           <label for="middle_name_of_approving_officer" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs"> Middle name *</label>
                                    </div>
                                 </div>
               ...
               <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                           ...
                           <select name="suffix_of_approving_officer"  id="suffix_of_approving_officer" class="focus:ring-1 focus:ring-blue-600  block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                           <option value=""    {{old('suffix_of_approving_officer') == "" ?    'selected' : ''}}>  Suffix </option>
                           <option value="Jr." {{old('suffix_of_approving_officer') == "Jr." ? 'selected' : ''}}>Jr.</option>
                           <option value="Sr." {{old('suffix_of_approving_officer') == "Sr." ? 'selected' : ''}}>Sr.</option>
                           <option value="I"   {{old('suffix_of_approving_officer') == "I" ?   'selected' : ''}}>I</option>
                           <option value="II"  {{old('suffix_of_approving_officer') == "II" ?  'selected' : ''}}>II</option>
                           <option value="III" {{old('suffix_of_approving_officer') == "III" ? 'selected' : ''}}>III</option>
                           <option value="IV"  {{old('suffix_of_approving_officer') == "IV" ?  'selected' : ''}}>IV</option>
                           <option value="V"   {{old('suffix_of_approving_officer') ==  "V" ?   'selected' :''}}>V</option>           
...
<!-- start 0f 6 -->
        <div class="carousel">
        <div class="carousel-content ">
             <div class="slide relative border border-gray-200 rounded-lg bg- bg-white mt-5 "id="slide6">           
                 <h6 class="text-blueGray-400 text-xl mt-3 mb-10 font-bold uppercase ml-5 ">  Member6  Information   </h6>                                      
                 <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>              
                <div class="flex flex-wrap mt-5">
                            <div class="w-full lg:w-4/12 px-4">
                                  <div class="relative w-full mb-3 mt-5">
                                         <input autocomplete="off"  name="pwd_no" id="pwd_no" type="integer" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="pwd_no" />
                                         <label for="pwd_no" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Pwd No.</label>
                                    </div>
                                 </div>
                             ...
                             <div class="w-full lg:w-4/12 px-4">
                                  <div class="relative w-full mb-3 mt-7">
                                           <input autocomplete="off"  name="date_applied" id="date_applied" type="date" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="date_applied" />
                                          <label for="date_applied" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Date Applied</label>
                                  </div>
                             </div>
                           ...
                           <div class="w-full lg:w-4/12 px-4">
                                <div class="relative w-full mb-3 mt-5">
                                              <input autocomplete="off" id="last_name" name="last_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="last_name." />
                                              <label for="last_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Last Name</label>
                                </div>
                           </div>
                          ...
                          <div class="w-full lg:w-4/12 px-4">
                                 <div class="relative w-full mb-3 mt-5">
                                           <input autocomplete="off"  id="middle_name" name="middle_name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="middle_name" />
                                           <label for="middle_name" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Middle Name</label>
                               </div>
                           </div>
                         ...
                         <div class="w-full lg:w-4/12 px-4">
                          ...
                          <div class="w-full lg:w-4/12 px-4">
                                 <div class="relative w-full mb-3 mt-7">
                                       <input autocomplete="off"  id="birthday" name="birthday" type="date" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" />
                                       <label for="birthday" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-900 peer-focus:text-xs">Birthday</label>
                                 </div>
                           </div>
                     ...
                     <div class="carousel">
        <div class="carousel-content ">
             <div class="slide relative border border-gray-200 rounded-lg bg- bg-white mt-5 "id="slide7">           
                 <h6 class="text-blueGray-400 text-xl mt-3 mb-10 font-bold uppercase ml-5 ">  Member7  Information   </h6>                                      
                 <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>              
                <div class="flex flex-wrap mt-5">
                            <div class="w-full lg:w-4/12 px-4">
                                  <div class="relative w-full mb-3 mt-5">
                     ...
                     <div class="carousel">
        <div class="carousel-content ">
             <div class="slide relative border border-gray-200 rounded-lg bg- bg-white mt-5 "id="slide8">           
                 <h6 class="text-blueGray-400 text-xl mt-3 mb-10 font-bold uppercase ml-5 ">  Member8  Information   </h6>                                      
                 <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>              
                <div class="flex flex-wrap mt-5">
                            <div class="w-full lg:w-4/12 px-4">
                                  <div class="relative w-full mb-3 mt-5">
                     ...
                     <div class="carousel">
        <div class="carousel-content ">
             <div class="slide relative border border-gray-200 rounded-lg bg- bg-white mt-5 "id="slide9">           
                 <h6 class="text-blueGray-400 text-xl mt-3 mb-10 font-bold uppercase ml-5 ">  Member9  Information   </h6>                                      
                 <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>              
                <div class="flex flex-wrap mt-5">
                            <div class="w-full lg:w-4/12 px-4">
                                  <div class="relative w-full mb-3 mt-5">
                     ...
                     <div class="carousel">
        <div class="carousel-content ">
             <div class="slide relative border border-gray-200 rounded-lg bg- bg-white mt-5 "id="slide10">           
                 <h6 class="text-blueGray-400 text-xl mt-3 mb-10 font-bold uppercase ml-5 ">  Member10  Information   </h6>                                      
                 <hr class="border-1 border-stone-200 hover:border-green-500 drop-shadow-xl"/>              
                <div class="flex flex-wrap mt-5">
                            <div class="w-full lg:w-4/12 px-4">
                                  <div class="relative w-full mb-3 mt-5">
