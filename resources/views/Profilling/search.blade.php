...
<!-- 
    ...
    <a href="{{ route('export') }}" class="btn btn-primary bg-green-500 hover:bg-blue-700 text-white py-2 px-4 rounded mt-1">
        Export to Excel
    </a>
</div>
...
<div class="flex flex-col mt-10">
            ...
            <thead class="border-b font-medium dark:border-black  bg-gray-100">
              <tr>
               ...
               <th scope="col" class="px-6 py-4">Occupations</th> 
                ...
                <th scope="col" class="px-6 py-4">Expired_applied</th> 
    ...
    <td class="whitespace-nowrap px-6 py-4">{{ $result->expirationDate }}</td>
