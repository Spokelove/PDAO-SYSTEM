...
<div>
    <form method="GET" action="/filter">
        <div class="flex flex-wrap my-5 -mx-2 bg-gray-50">
            ...
            <div class="w-full lg:w-3/12 px-4">
                <!-- Filter Button -->
                <button class="bg-green-500 hover:bg-blue-700  text-white py-2 px-4 rounded mt-6">
                    Filter
                </button>
            </div>
        </div>
...
<div class="flex flex-col mt-10">
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
        <div class="overflow-hidden">
          <table class="min-w-full text-left text-sm font-light text-black bg-gray">
            <thead class="border-b font-medium dark:border-black  bg-gray-100">
              <tr>
                <!-- <th scope="col" class="px-6 py-4">ID</th> -->
                <!-- <th scope="col" class="px-6 py-4">Pwd_Id</th> -->
                <th scope="col" class="px-6 py-4">Pwd_no</th>
                ...
                <th scope="col" class="px-6 py-4">Middlename</th> 
                 ...
                 <th scope="col" class="px-6 py-4">Type of Disability</th>
                 <th scope="col" class="px-6 py-4">Cause of Disability</th>    
                ...
                <th scope="col" class="px-6 py-4">Civil Status</th> 
                <th scope="col" class="px-6 py-4">Educational Attianment</th> 
               <th scope="col" class="px-6 py-4">Occupations</th> 
                <th scope="col" class="px-6 py-4">Father Lastname</th>
                <th scope="col" class="px-6 py-4">Father Firstname</th>
                <th scope="col" class="px-6 py-4">Father Middlename</th>
                <th scope="col" class="px-6 py-4">Mother Lastname</th>
                <th scope="col" class="px-6 py-4">Mother Firstname</th>
                <th scope="col" class="px-6 py-4">Mother Middlename</th>
                <th scope="col" class="px-6 py-4">Guardian Lastname</th>
                <th scope="col" class="px-6 py-4">Guardian Firstname</th>
                <th scope="col" class="px-6 py-4">Guardian Middlename</th>
                <th scope="col" class="px-6 py-4">Mobilization</th>  
                <!-- <th scope="col" class="px-6 py-4">Other Specify</th>   -->
    ...
    <td class="whitespace-nowrap px-6 py-4">{{ $result->pwd_no }}</td>
    ...
    <td class="whitespace-nowrap px-6 py-4">{{ $result->suffix_of_applicant }}</td>
    ...
    <td class="whitespace-nowrap px-6 py-4">{{ $result->gender }}</td>
    <td class="whitespace-nowrap px-6 py-4" style="color: {{ $result->age >= 60 ? 'red' : 'black' }}">
                    {{ $result->age }}
    </td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->status }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->educational_attain }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->occupations }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->father_last_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->father_first_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->father_middle_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->mother_last_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->mother_first_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->mother_middle_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->guardian_last_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->guardian_first_name }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $result->guardian_middle_name }}</td>
    ...
    <!-- <td class="whitespace-nowrap px-6 py-4">{{ $result->first_name_of_control_unit }}</td> -->
    <td class="whitespace-nowrap px-6 py-4">{{ $result->date_applied }}</td>
    <td class="whitespace-nowrap px-6 py-4">{{ $expirationDateString }}</td>
                ...
                <td class="px-4 py-4 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <a href="{{route('result.edit',['result' => $result])}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="float-right mt-5">
           <a href ="{{url('/profilling')}}"  button class="  space-x-px space-x-36 mb-3  bg-blue-500 text-white active:bg-green-900 text-xs px-2 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
            Refresh
            </button></a> 
