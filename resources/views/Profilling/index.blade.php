 ...
 <nav class="flex px-5 py-3 text-gray-700 rounded-lg bg-stone-100 dark:bg-[#1E293B]" aria-label="Breadcrumb">
    ...
    <li class="inline-flex items-center">
        <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
            ...
            <a href="{{ route('export') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-green-400  py-2 px-4 rounded">
                <span>Master All List </span>
                <!-- <svg class = "w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg> -->
            </a>
    ...
    <style>
        ...
        <li>
        <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
            <a href="{{ route('export.perbarangay') }}"  class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-green-400  py-2 px-4 rounded">
                
                <span>Total Per Barangay</span>
            </a>
        </div>    
    </li>
    ...
    <li>
            <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                <!-- Export to Excel Button for All PWDMembers -->
                <a href="{{ route('export.listperbarangay') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-green-400  py-2 px-4 rounded">
                    <span>List Per Barangay</span>
                </a>
            </div>
        </li>    
        ...
        <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
            <!-- Export to Excel Button for All PWDMembers -->
            <a href="{{ route('export.senior') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-green-400  py-2 px-4 rounded">
        ...
        <!-- <li>
            <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                <!-- Export to Excel Button for All PWDMembers -->
                <!-- <a href="{{ route('export.types') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-green-400  py-2 px-4 rounded">
                    <span>Disabilities Per Barangay</span>
                </a>
            </div>
        </li>    -->
 </ol>
          ...
          <table class="min-w-full text-left text-sm font-light text-black bg-gray id="data-table" class="display">
            <thead class="border-b font-medium dark:border-black  bg-gray-100">
              <tr>
                ...
                <th scope="col" class="px-6 py-4">Types of Disability</th>
               <th scope="col" class="px-6 py-4">Cause of  Disability</th>  
                <th scope="col" class="px-6 py-4">Mobilization/Devices</th> 
              ...
              <tr
               ...
               <td class="whitespace-nowrap px-6 py-4">{{ $result->date_applied}}</td> 
                ...
                <td class="whitespace-nowrap px-6 py-4">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{ $result->middle_name_of_reporting_unit}}</td>     

                <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <a href="{{ route('pwdprofile.index', ['result' => $result->id]) }}">
