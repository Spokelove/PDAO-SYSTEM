 ...
 <nav class="flex px-5 py-3 text-gray-700 rounded-lg bg-stone-100 dark:bg-[#1E293B]" aria-label="Breadcrumb">
    ...
    <!-- =========================================export to excel==================================================================================================     -->
                    ...
                    <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                        ...
                        <a href="{{ route('export') }}" class="btn btn-primarybg-stone-100 hover:bg-green-400 py-2 px-4 rounded mt-1">
                            <span>Export All List </span>
                        </a>
                    </div>
                </li>
        ...
        <li>
                    <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                        <!-- Export to Excel Button for All PWDMembers -->
                        <a href="{{ route('export.perbarangay') }}"  class="btn btn-primarybg-stone-100 hover:bg-green-400 py-2 px-4 rounded mt-1">
                            <span>Export List Per Barangay</span>
                        </a>
                    </div>
             ...
             <!-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-4 h-4 mr-2">
              ...
              <li>
                    <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                        <!-- Export to Excel Button for All PWDMembers -->
                        <a href="" class="btn btn-primarybg-stone-100 hover:bg-green-400 py-2 px-4 rounded mt-1">
                            <span>Export Senior Citizen </span>
                        </a>
                    </div>
                </li>
    </ol>
          ...
          <table class="min-w-full text-left text-sm font-light text-black bg-gray id="data-table" class="display">
            ...
            @foreach ($results as $result)
              ...
              <tr
               ...
               <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $result->application}}</td>
