...
<form method="GET" action="/filter">
    <div class="flex flex-wrap my-5 -mx-2 bg-gray-50">
        <div class="flex flex-wrap w-full">
            <div class="w-full lg:w-3/12 px-4"> <!-- Adjusted width for the first date input -->
                <div class="relative w-full mb-3">
                    <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="start">
                        Start
                    </label>
                    <input type="date" id="start" name="start_date" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="000-00-00">
                </div>
            </div>
            <div class="w-full lg:w-3/12 px-4"> <!-- Adjusted width for the second date input -->
                <div class="relative w-full mb-3">
                    <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="end">
                        End
                    </label>
                    <input type="date" id="end" name="end_date" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="000-00-00">
                </div>
            </div>
            <div class="w-full lg:w-3/12 px-4"> <!-- Adjusted width for the button container -->
          ...
          <table class="min-w-full text-left text-sm font-light text-black bg-gray">
            <thead class="border-b font-medium dark:border-black  bg-gray-100">
              <tr>
                ...
                <th scope="col" class="px-6 py-4">House and Street</th>
            ...
            @foreach ($results as $result)
              ...
              <tr
                ...
                <td class="whitespace-nowrap px-6 py-4">{{ $result->house_and_street}}</td>
