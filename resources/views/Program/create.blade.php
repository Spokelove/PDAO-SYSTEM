...
<section class="mt-10 ">
       ...
       <form action="{{ route('programassistance.store') }}"  method="post" class= "flex flex-col">
           @csrf
                         ...
                         <div class="max-w-md mx-auto">
                           ...
                           <div class="divide-y divide-gray-200  mt-5">
                             <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                               <div class="relative">
                                 <input autocomplete="off" id="Program_Types" name="Program_Types" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600">
