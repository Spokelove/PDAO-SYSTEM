...
<section class="mt-10 ">
            ...
            <div>
                ...
                @endif
                                ...
                                <form action="{{ route('programassistance.update', ['programassistance' => $programassistance]) }}" method="post" class="flex flex-col">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="max-w-5lg py-6 flex flex-col justify-center sm:py-12">
                            <div class="shadow-lg shadow-blue-500/50 relative py-3 sm:max-w-xl sm:mx-auto w-full bg-blue-500 rounded-xl">
                                <div class="shadow-lg shadow-green-200/50 absolute inset-0 bg-gradient-to-r from-green-600 to-green-900 rounded-lg shadow-2xl transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
                                <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                                    <div class="max-w-md mx-auto">
                                        <div>
                                            <h1 class="font-sans-saref text-center text-xl font-bold shadow-lg shadow-green-200/50"> Types of Program</h1>
                                        </div>
                                        <div class="divide-y divide-gray-200 mt-5">
                                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                                <div class="relative">
                                                    <input autocomplete="off" id="Program_Types" name="Program_Types" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" value="{{  $programassistance->Program_Types}}">
                                                    <label for="Program_Types" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-green-900 peer-focus:text-xs">Program_Types</label>
