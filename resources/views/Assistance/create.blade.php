...
<div class="text-center px-4 uppercase text-xl">Devices Given Form</div>

<form action="#" method="post" enctype="multipart/form-data" class="">
    @csrf

    <!-- Trigger button -->
    <button type="button" class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-white m-5 show-modal">Add Device</button>

    <!-- Modal -->
    <div id="myModal" class="modal h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50 hidden">
        <div class="bg-white p-8 rounded shadow-md">
            <h2 class="text-2xl font-bold mb-4">Add Device</h2>
            <!-- Input fields -->
            <form action="#" method="post" enctype="multipart/form-data" class="">
            @csrf
                <label for="device" class="block text-sm font-medium text-gray-600">Device:</label>
                <input type="text" id="device" name="device" class="border rounded px-3 py-1 w-full mb-4">

                <label for="quantity" class="block text-sm font-medium text-gray-600">Quantity:</label>
                <input type="number" id="quantity" name="quantity" class="border rounded px-3 py-1 w-full mb-4">

                <!-- Change label to "Date Received" -->
                <label for="dateReceived" class="block text-sm font-medium text-gray-600">Date Received:</label>
                <input type="date" id="dateReceived" name="dateReceived" class="border rounded px-3 py-1 w-full mb-4">

                <!-- Buttons -->
                <button type="button" id="closeModal" class="bg-gray-500 hover:bg-gray-600 px-3 py-1 rounded text-white mr-2">Close</button>
                <button type="button" id="saveButton" class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-white">Save</button>
                </form>
        </div>
    </div>
    ...
    let totalDevices = 0; // Step 1: Initialize total variable
    ...
    saveButton.addEventListener('click', function () {
        ...
        // Step 2: Update totalDevices
        totalDevices += parseInt(quantity);

        // Step 3: Update the total in the table
        const totalElement = document.getElementById('totalDevices');
        totalElement.innerText = totalDevices;

        // Close the modal after saving
        modal.classList.add('hidden');
    });

    // Prevent form submission by using the "button" type instead of "submit"
...
<div class="container mx-auto p-8">
    <table class="min-w-full bg-white border border-gray-300">
        <thead>
            <tr>
                <th class="py-2 px-4 border-b">DEVICES</th>
                ...
                <td class="py-2 px-4 border-t font-bold text-center" id="totalDevices">0</td>
            </tr>
