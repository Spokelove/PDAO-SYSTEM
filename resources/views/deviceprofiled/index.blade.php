               ...
               <td class="whitespace-nowrap px-6 py-4">
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110"> <!-- Change hover:text-purple-500 to hover:text-blue-500 -->
                                            <a href="{{ route('result.edit', ['result' => $result->id]) }}">
                                                <svg class="text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
