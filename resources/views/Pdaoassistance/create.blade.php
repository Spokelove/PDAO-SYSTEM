...
<!-- 
 ...
 <!-- <start of content> -->
<!-- Table -->
<h6 class="text-blueGray-400 text-xl font-bold uppercase ml-5 text-black-600 text-center mt-10">PERSON WITH DISABILITY OFFICE AFFAIRS</h6>
<div class="text-center px-4 uppercase text-xl"> Types of Assistance Given</div>



 
<div class="border border-gray-500 rounded-lg bg-white p-5 container mx-auto max-w-50 mt-10">
    <h2 class="text-base font-semibold leading-7 text-gray-900 text-xl">Personal Information</h2>
    ...
    <form action="{{ route('pdaoassistance.store') }}" method="post" enctype="multipart/form-data" class="mt-10">
        @csrf
        ...
        <div class="flex justify-between">
            <div class="inline-flex border  lg:-mx-0 rounded lg:w-full px-0 lg:px-2 h-12 bg-transparent">
                <div class="flex flex-wrap items-stretch w-full h-full mb-6 relative">
                    <div class="flex">
                        <span class="flex items-center leading-normal bg-transparent rounded rounded-r-none border border-r-0 border-none lg:px-3 py-2 whitespace-no-wrap text-black text-xl">
                    ...
                    <input type="text" class="flex-shrink flex-grow flex-auto leading-normal tracking-wide w-px flex-1 border border-none border-l-0 rounded rounded-l-none px-3 relative focus:outline-none text-xl lg:text-xl lg:text-base text-black font-bold" placeholder="Search">
                </div>
            </div>
        </div>
...
<!-- 
  search -->
        ...
        <div class="grid grid-cols-5 gap-x-6 gap-y-8 sm:grid-cols-4 ml-5 mt-5">
            <div class="sm:col-span-3 flex gap-x-4 ml-5">
                <div class="w-1/3">
                    <label for="last_name" class="block text-sm font-medium leading-6 text-gray-900">Last Name</label>
                    <input type="text" name="last_name" id="last_name" autocomplete="last_name" placeholder="Last Name" class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>

                <div class="w-1/3">
                    <label for="first_name" class="block text-sm font-medium leading-6 text-gray-900">First name</label>
                    <input type="text" name="first_name" id="first_name" autocomplete="first_name" placeholder="First Name" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>

                <div class="w-1/3">
                    <label for="middle_name" class="block text-sm font-medium leading-6 text-gray-900">Middle Name</label>
                    <input type="text" name="middle_name" id="middle_name" autocomplete="middle_name" placeholder="Middle Name" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>

            <div class="w-1/2">
                <label for="suffix" class="block text-sm font-medium leading-6 text-gray-900">Suffix</label>
                <select name="suffix" id="suffix" autocomplete="suffix" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    <option value=""></option>
                    <option value="Jr">Jr</option>
                    <option value="Jr">Sr</option>
                    <option value="Jr">I</option>
      ...
      <hr class="mt-5" style="color: black; font-weight: bold;">
                        ...
                        <div class="grid grid-cols-5 gap-x-6 gap-y-8 sm:grid-cols-5 ml-3 mt-7">
                            <div class="sm:col-span-3 flex gap-x-4 ml-5">
                            <div class="w-1/3">
                    <label for="birthday" class="block text-sm font-medium leading-6 text-gray-900">Birthday</label>
                    <input type="date" name="birthday" id="birthday" autocomplete="birthday" placeholder="Birthday" 
                        class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 
                    ...
                    <input type="text" name="age" id="age" autocomplete="age" placeholder="Age" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" readonly>
                </div>
                ...
                <script>
                    function calculateAge() {
                        ...
                        // Get the selected date from the birthday input
                ...
                <div class="w-1/2 ml-5">
                            ...
                            <input type="text" name="Barangay" id="Barangay" autocomplete="Barangay" placeholder="Barangay" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>

                        <div class="w-1/2">
                            <label for="purok" class="block text-sm font-medium leading-6 text-gray-900">Purok</label>
                            <input type="text" name="purok" id="purok" autocomplete="purok" placeholder="Purok" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>

                    <div class="w-full">
                    <label for="gender" class="block text-sm font-medium leading-6 text-gray-900">Gender</label>
                    <select name="gender" id="gender" autocomplete="gender" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="w-full">
                <label for="identification" class="block text-sm font-medium leading-6 text-gray-900">Identification / ID</label>
                <input type="text" name="identification" id="identification" autocomplete="identification" placeholder="identification" class="  p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
                
    


            <div class="sm:col-span-5 flex gap-x-5 ml-5">

                    <div class="w-full">
                        <label for="disability" class="block text-sm font-medium leading-6 text-gray-900">Disability</label>
                        <input type="text" name="disability" id="disability" autocomplete="disability" placeholder="Disability" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>

                    <div class="w-1/2">
                        <label for="date_received" class="block text-sm font-medium leading-6 text-gray-900">Date Received:</label>
                        <input type="date" name="date_received" id="date_received" autocomplete="date_received" placeholder="Date Received" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                

                <div class="w-full">
                    <label for="assistance" class="block text-sm font-medium leading-6 text-gray-900">Types of Assistance</label>
                    <input type="text" name="assistance" id="assistance" autocomplete="assistance" placeholder="Types of Assistance" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>


                <div class="w-full">
                    <label for="remarks" class="block text-sm font-medium leading-6 text-gray-900">Remarks</label>
                    <input type="text" name="remarks" id="remarks" autocomplete="remarks" placeholder="Remarks" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>

                <div class="w-full">
                    <label for="program" class="block text-sm font-medium leading-6 text-gray-900">Types of Program</label>
                    <input type="text" name="program" id="program" autocomplete="program" placeholder="Program" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                ...
                <div class="sm:col-span-3 flex gap-x-3  mt-5">

                <div class="w-1/5 ml-8">
                        <label for="amount" class="block text-sm font-medium leading-6 text-gray-900">Amount</label>
                        <input type="text" name="amount" id="amount" autocomplete="amount" placeholder="amount" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>

                    <div class="w-1/5">
                        <label for="Unit" class="block text-sm font-medium leading-6 text-gray-900">Unit</label>
                        <input type="text" name="Unit" id="Unitd" autocomplete="Unit" placeholder="Unit" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    ...
                    <div class="w-1/5">
                        ...
                        <input type="text" name="description" id="description" autocomplete="description" placeholder="description" class="p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
               </div>

        
                    <div class="float-right mt-10 flex justify-center">
                      <button type="submit" class="rounded-md bg-green-600 px-10 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                </div>
