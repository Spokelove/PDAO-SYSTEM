    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0l.229 2.523a1.125 1.125 0 01-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.318 0h1.091A2.25 2.25 0 0021 15.75V9.456c0-1.081-.768-2.015-1.837-2.175a48.055 48.055 0 00-1.913-.247M6.34 18H5.25A2.25 2.25 0 013 15.75V9.456c0-1.081.768-2.015 1.837-2.175a48.041 48.041 0 011.913-.247m10.5 0a48.536 48.536 0 00-10.5 0m10.5 0V3.375c0-.621-.504-1.125-1.125-1.125h-8.25c-.621 0-1.125.504-1.125 1.125v3.659M18 10.5h.008v.008H18V10.5zm-3 0h.008v.008H15V10.5z" />
             ...
             PDAO Types of Assistance Records 
            </a>
    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
          ...
          <table class="min-w-full text-left text-sm font-light text-black bg-lime-100 id="data-table" class="display">
            <thead class="border-b font-medium dark:border-black  bg-stone-100">
              <tr>
                ...
                <th scope="col" class="px-6 py-4">Identification CARD</th>  
                <th scope="col" class="px-6 py-4">Disability</th>          
                <th scope="col" class="px-6 py-4">Date Recieved</th>             
                <th scope="col" class="px-6 py-4">Actions</th>
              </tr>


              @foreach ($assistanceRecords  as   $assistanceRecord)
        ...
        class="border-b transition duration-300 ease-in-out hover:bg-gray-100 dark:border-gray-100 dark:hover:bg-gray-100 bg-white">
          <td class="whitespace-nowrap px-6 py-4 font-medium">{{  $assistanceRecord->id}}</td>
         <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->last_name}}</td> 
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->first_name}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->middle_name}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->suffix}}</td>   
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->birthday}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->age}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->gender}}</td>       
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->Barangay}}</td>  
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->purok}}</td>  
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->assistance}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->identification}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->disability}}</td>  
          <td class="whitespace-nowrap px-6 py-4">{{  $assistanceRecord->date_received}}</td>
