...
<div class="text-center px-4 uppercase text-xl">Assistance Given</div>


<div class="container mx-auto mt-10 max-w-md">
    <div class="border border-gray-500 rounded-lg bg-white p-5">
        <h2 class="text-xl font-semibold leading-7 text-gray-900e text-center">MasterList Information</h2>
        ...
        <form action="{{ route('masterlist.store') }}" method="post" enctype="multipart/form-data" class="mt-10">
            @csrf

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                <label for="Types_id" class="p-1 block text-sm font-medium text-gray-900">Types of Assistance</label>
                <select name="Types_id" id="Types_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                        <option value=""> Select Assistance</option>
                        @foreach($typesOfAssistance as $type)
                            <option value="{{ $type->id }}">{{ $type->Assistance_Types }}</option>
                        @endforeach
                    </select>
                </div>

                <div>
                    <label for="Program_id" class=" p-1 block text-sm font-medium text-gray-900">Types of Program</label>
                    <select name="Program_id" id="Program_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                        <option value="">Select  Program</option>
                        @foreach($typesOfProgram as $program)
                            <option value="{{ $program->id }}">{{ $program->Program_Types }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-5">
                <div>
                    <label for="Amount" class="block text-sm font-medium text-gray-900 p-1">Amount</label>
                    <input type="decimal" name="Amount" id="Amount" autocomplete="off" placeholder="Amount" class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>

                <div>
                    <label for="Unit" class="block text-sm font-medium text-gray-900 p-1">Unit</label>
                    <input type="text" name="Unit" id="Unit" autocomplete="off" placeholder="Unit" class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-7">
                <div>
                    <label for="Particular" class="block text-sm font-medium text-gray-900 p-1">Particular</label>
                    <input type="text" name="Particular" id="Particular" autocomplete="off" placeholder="Particular" class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" onchange="calculateAge()">
                </div>

                <div>
                    <label for="Assistance_Name" class="block text-sm font-medium text-gray-900 p-1">Assistance Name</label>
                    <input type="text" name="Assistance_Name" id="Assistance_Name" autocomplete="Assistance_Name" placeholder="Assistance Name" class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>

                <div>
                    <label for="Description" class="block text-sm font-medium text-gray-900 p-1">Description</label>
                    <input type="text" name="Description" id="Description" autocomplete="off" placeholder="Description" class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>
            </div>

            <div class="flex justify-end mt-10">
                <button type="submit" class="px-10 py-2 text-sm font-semibold text-white bg-green-600 rounded-md shadow-sm hover:bg-blue-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600">Save</button>
            </div>
        </form>
    </div>
</div> -->
...
<div>
                ...
                <form action="{{ route('masterlist.update', ['masterlist' => $masterlist->id]) }}" method="post" class="flex flex-col">
                    @csrf
                    @method('PUT')
                        
                                  
                 <div class="max-w-5lg py-6 flex flex-col justify-center sm:py-12 mt-12 ">
                     ...
                     <div class=" shadow-lg shadow-blue-500/50 relative py-3 sm:max-w-xl sm:mx-auto w-full  bg-blue-500 rounded-xl">
                       ...
                       <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                         <div class="max-w-md mx-auto">
                           <div>
                             <h1 class=" font-sans-saref text-center text-xl font-bold shadow-lg shadow-green-200/50">Masterlist of Assistance</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-5">
                <div>
                    <label for="Amount" class="block text-sm font-medium text-gray-900 p-1">Amount</label>
                    <input type="decimal" name="Amount" id="Amount" autocomplete="off" placeholder="Amount" value="{{ $masterlist->Amount }}"
                     class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>

                <div>
                    <label for="Unit" class="block text-sm font-medium text-gray-900 p-1">Unit</label>
                    <input type="text" name="Unit" id="Unit" autocomplete="off" placeholder="Unit" value="{{ $masterlist->Unit }}"
                     class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-7">
                <div>
                    <label for="Particular" class="block text-sm font-medium text-gray-900 p-1">Particular</label>
                    <input type="text" name="Particular" id="Particular" autocomplete="off" placeholder="Particular" value="{{ $masterlist->Particular }}"
                    class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" onchange="calculateAge()">
                </div>

                <div>
                    <label for="Assistance_Name" class="block text-sm font-medium text-gray-900 p-1">Assistance Name</label>
                    <input type="text" name="Assistance_Name" id="Assistance_Name" autocomplete="Assistance_Name" placeholder="Assistance Name" value="{{ $masterlist->Assistance_Name }}"
                    class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>

                <div>
                    <label for="Description" class="block text-sm font-medium text-gray-900 p-1">Description</label>
                    <input type="text" name="Description" id="Description" autocomplete="off" placeholder="Description"  value="{{ $masterlist->Description }}"
                    class=" p-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>
            </div>
