...
<!--  
======================================START OF TABLE=========================================================================================================== -->
<li class="inline-flex items-center mt-10">

<div class="w-full lg:w-12/12 px-4" style="text-align: right;">
            <!-- Export to Excel Button for All PWDMembers -->
            <a href="{{url('/MasterList/create')}}" class="inline-flex items-center text-sm font-medium text-white bg-green-500   dark:text-white dark:hover:text-white hover:bg-blue-700 py-2 px-4 rounded">
    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden">
                <table class="min-w-full text-left text-sm font-light text-black bg-lime-100" id="data-table">
                    <thead class="border-b font-medium dark:border-black bg-stone-100">
                        <tr>
                            <th scope="col" class="px-6 py-4">ID</th>
                            <th scope="col" class="px-6 py-4">Type of Assistance</th>
                            <th scope="col" class="px-6 py-4">Type of Program</th>
                    ...
                    <tbody>
                        @foreach ($masterlists as $masterlist)
                            <tr class=" px-5 py-4  border-b transition duration-300 ease-in-out hover:bg-gray-100 dark:border-gray-100 dark:hover:bg-gray-100 bg-white">
                                <td class="whitespace-nowrap px-6 py-4">{{ $masterlist->id }}</td>
                               
                                <td class="whitespace-nowrap px-6 py-4">{{ optional($masterlist->typesOfAssistance)->Assistance_Types }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ optional($masterlist->typesOfProgram)->Program_Types }} </td>                                                                                                                                              
                                <td class="whitespace-nowrap px-6 py-4">{{ $masterlist->Amount }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ $masterlist->Unit }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ $masterlist->Particular }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ $masterlist->Assistance_Name }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ $masterlist->Description }}</td>

                                <td class="px-5 py-4 mr-5 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                            <a href="{{ route('masterlist.edit', ['masterlist' => $masterlist]) }}">
                                ...
                                <form id="deleteForm{{ $masterlist->id }}" action="{{ route('masterlist.destroy', ['masterlist' => $masterlist->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" name="id" value="{{ $masterlist->id }}">
                                    <button type="submit" class="delete-btn w-4 mr-2 transform hover:text-purple-500 hover:scale-110" onclick="return confirm('Are you sure you want to delete this item?')">
