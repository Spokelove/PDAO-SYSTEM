    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v8.25m0 0l-3-3m3 3l3-3" />
                        ...
                        <span> Add MasterLedger Assistance</span>
    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
        ...
        class="border-b transition duration-300 ease-in-out hover:bg-gray-100 dark:border-gray-100 dark:hover:bg-gray-100 bg-white">
          <td class="whitespace-nowrap px-6 py-4 font-medium">{{$masterledger->id}}</td>
 
          <td class="whitespace-nowrap px-6 py-4">{{   $masterledger->last_name}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{   $masterledger->first_name}}</td>
          <td class="whitespace-nowrap px-6 py-4">{{   $masterledger->middle_name}}</td>   
          <td class="whitespace-nowrap px-6 py-4">{{   $masterledger->suffix_of_applicant}}</td> 
          <td class="whitespace-nowrap px-6 py-4">{{   $masterledger->typesOfAssistance->Assistance_Types }}</td>


          <td class="whitespace-nowrap px-6 py-4">{{  $masterledger->typesOfProgram->Program_Types }}</td>       
          <td class="whitespace-nowrap px-6 py-4">{{  $masterledger->Amount}}</td>

          <td class="whitespace-nowrap px-6 py-4">{{  $masterledger->Unit }}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $masterledger->Particular }}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $masterledger->Assistance_Name }}</td>
          <td class="whitespace-nowrap px-6 py-4">{{  $masterledger->Description }}</td>
         <td class="whitespace-nowrap px-6 py-4">{{   $masterledger->Date_Received}}</td>
          ...
          <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                ...
                <div class="flex item-center justify-center">
                    ...
                    <a href="{{ route('masterledger.edit', ['masterledger' => $masterledger]) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
