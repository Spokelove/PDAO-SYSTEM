       ...
       Reports
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ">
            ...
            <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                <a href=""   class="inline-flex items-center text-sm font-medium text-white bg-green-500   dark:text-white dark:hover:text-white hover:bg-blue-700 py-2 px-4 rounded">
                    
                    <span>MasterLedger List</span>
                </a>
            </div>    
        </li>
...
<li class="inline-flex items-center mt-5">

<div class="w-full lg:w-12/12 px-4" style="text-align: right;">
            <!-- Export to Excel Button for All PWDMembers -->
            <a href="{{url('/masterledger/create')}}" class="inline-flex items-center text-sm font-medium text-white bg-green-500   dark:text-white dark:hover:text-white hover:bg-blue-700 py-2 px-4 rounded">
    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
        <div class="overflow-hidden">
          <table class="min-w-full text-left text-sm font-light text-black bg-lime-100 id="data-table" class="display">
            <thead class="border-b font-medium dark:border-black  bg-stone-100">
              <tr>
                ...
                <th scope="col" class="px-6 py-4">Types of Assistance</th>
                <th scope="col" class="px-6 py-4">Types of Program</th>
                <th scope="col" class="px-6 py-4">Amount</th>            
                <th scope="col" class="px-6 py-4">Unit</th>
                <th scope="col" class="px-6 py-4">Particular</th>  
                <th scope="col" class="px-6 py-4">Assistance Name</th>      
                <th scope="col" class="px-6 py-4 text-center">Description</th>

                <th scope="col" class="px-6 py-4">Date Recieved</th>       
        ...
        <tr
        class="border-b transition duration-300 ease-in-out hover:bg-gray-100 dark:border-gray-100 dark:hover:bg-gray-100 bg-white">
        <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $masterledger->id ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->last_name ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->first_name ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->middle_name ?? 'N/A' }}</td>   
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->suffix_of_applicant}}</td> 
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->typesOfAssistance->Assistance_Types ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->typesOfProgram->Program_Types ?? 'N/A' }}</td>       
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->Amount ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->Unit ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->Particular ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->Assistance_Name ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->Description ?? 'N/A' }}</td>
        <td class="whitespace-nowrap px-6 py-4">{{ $masterledger->Date_Received ?? 'N/A' }}</td>
          ...
          <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                ...
                <div class="flex item-center justify-center">
                    <!-- <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                        ...
                        <a href="{{ route('masterledger.edit', ['masterledger' => $masterledger]) }}" class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-blue-500">
                    ...
                    <form action="{{ url('masterledger/'.$masterledger->id.'/destroy') }}" method="POST">
                        @csrf
                        @method('DELETE')
