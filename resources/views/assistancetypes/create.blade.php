...
<section class="mt-10 ">
       ...
       <form action="{{ route('typesofAssistance.store') }}"  method="post" class= "flex flex-col">
           @csrf
                         ...
                         <div class="max-w-md mx-auto">
                           ...
                           <div class="divide-y divide-gray-200  mt-5">
                             <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                               <div class="relative">
                                 <input autocomplete="off" id="Assistance_Types" name="Assistance_Types" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600">
                                 <label for="Assistance_Types" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-green-900 peer-focus:text-xs">Assistance_Types</label>
                               ...
                               <div class="relative">
                                 ...
                                 <button class="bg-blue-500 text-white rounded-md px-2 py-1 hover:bg-green-700 text-white w-full py-2 rounded-lg shadow-2xl hover: shadow-xl transition duration-200" type="submit">Save</button>
