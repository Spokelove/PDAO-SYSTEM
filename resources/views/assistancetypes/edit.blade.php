            ...
            <hr class="border-1 border-black-200 hover:border-green-500 drop-shadow-xl"/>   
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <div>
                            <a href="{{url('/MasterListofAssistance')}}" class="text-base leading-4">Assistance Master List</a>
                        </div>
                    </div>
...
<!-- 
        ...
        <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
           Export to Excel Button for All PWDMembers -->
            <!-- <a href="{{url('/TypesofAssistance/create')}}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-green-400  py-2 px-4 rounded">
                <span>Add Assistance </span>
               <svg class = "w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg> -->
            <!-- </a>
...
<section class="mt-10 ">
            ...
            <form action="{{ route('typesofAssistance.update', ['assistancetype' => $assistancetype]) }}" method="post" class="flex flex-col">
                    @csrf
                    @method('PUT')
                     ...
                     <div class=" shadow-lg shadow-blue-500/50 relative py-3 sm:max-w-xl sm:mx-auto w-full  bg-blue-500 rounded-xl">
                       ...
                       <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                         <div class="max-w-md mx-auto">
                           <div>
                             <h1 class=" font-sans-saref text-center text-xl font-bold shadow-lg shadow-green-200/50"> Types of Assistance</h1>
                      
                           </div>
                           <div class="divide-y divide-gray-200  mt-5">
                             <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                               <div class="relative">
                                 <input autocomplete="off" id="Assistance_Types" name="Assistance_Types" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" value="{{ $assistancetype->Assistance_Types }}" />
                                 <label for="Assistance_Types" class="absolute left-0 -top-3.5 text-black-300 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-green-900 peer-focus:text-xs">Types of Assistance</label>
