        ...
        <nav class = "flex px-5 py-3 text-gray-700 rounded-lg bg-stone-100 dark:bg-[#1E293B] " aria-label="Breadcrumb">
            <ol class = "inline-flex items-center space-x-1 md:space-x-3">
                ...
                <div class="w-full lg:w-12/12 px-4" style="text-align: right;">
                    ...
                    <a href="{{url('/TypesofAssistance/create')}}" class="inline-flex items-center text-sm font-medium text-white bg-green-500   dark:text-white dark:hover:text-white hover:bg-blue-700 py-2 px-4 rounded">
...
<div class="border border-white rounded-lg bg-white p-5 container mx-auto max-w-2xl mt-10">


    <!-- Table section -->
    <div class="overflow-x-auto sm:-mx-6 lmx-auto max-w-2xl mt-5">
        <div class="inline-block min-w-full overflow-hidden">
            <table class="min-w-full text-left text-sm font-light text-black bg-gray border border-gray-200"
                id="data-table">
                <thead class="border-b font-medium dark:border-black bg-gray-100">
                    <tr>
                        <th scope="col" class="px-6 py-4 w-1/3">ID</th>
                        <th scope="col" class="px-6 py-4 w-1/3">Types of Assistance</th>
                ...
                @foreach ($assistancetypes as $assistancetype)
                            ...
                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $assistancetype->id }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ $assistancetype->Assistance_Types }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-black-500 text-sm leading-5">
                                    <div class="flex item-center justify-center">
                                     ...
                                     <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                     <a href="{{ route('typesofAssistance.edit', ['assistancetype' => $assistancetype]) }}">
                                        ...
                                        <form action="{{ route('typesofAssistance.destroy', ['assistancetype' => $assistancetype]) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
